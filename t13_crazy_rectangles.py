...
def main():
    ...
    for i in range(25):
        ...
        p = Point(random.randrange(500)-250, random.randrange(500)-250)     # could use grow function here

        # a rectangle object which starts at the point defined above
        rect = rectangle.Rectangle(p, random.randrange(i+100), random.randrange(i+100))     # move function
        # rect = rectangle.Rectangle()
        # rect.move(random.randrange(i+100), random.randrange(i+100))
        # rect.grow(500, 500)
